...
\frame{
    ...
    \medskip
    \begin{center}
        \tiny{Also thanks : Curt Tilmes, Hook Hua, Brian Wilson, Gerald Manipon, Bradley Akamine,
            Amanda McQueen,\\ Peter Fox, Marshall Ma and the Tetherless World Institute at RPI
        }
    \end{center}
}
