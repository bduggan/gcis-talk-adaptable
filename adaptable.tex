...
\frame{
    The Global Change Information System (GCIS) provides a way to
    access timely structured information about global change.  \\
}

\frame{
    The first public release of GCIS was in May, 2013.\\
    Initial population of the database was driven by supporting {\bf the
    Third National Climate Assessment}.  This was released in May, 2014.
}
