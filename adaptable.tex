...
\subsection{The Third National Climate Assessment}
\frame{
    \frametitle{\insertsubsectionhead}
    On May 6, 2014, the US Global Change Research Program released
...
\frame{
    ...
    \begin{itemize}
        \item 829 pages
        \item Over 300 \textcolor{blue}{authors}, numerous editors, analysts, graphics producers, scientists, data scientists, software developers, and web teams
        \item 161 \textcolor{blue}{findings}, 284 \textcolor{blue}{figures}, 3,395 bibliographic \textcolor{blue}{references} (journal \textcolor{blue}{articles}, \textcolor{blue}{books}, \textcolor{blue}{reports}
    \end{itemize}
...
%#     Report Construction
%#     \begin{itemize}
%#         \item Various sources spreadsheets, google docs, email, endnote, scientific software, CMSs.
%#         \item Common points of reference and vocabulary
%#         \item Uniform Resource Identifiers and URLs
...
%#     \frametitle{\insertsubsectionhead}
%#     \begin{itemize}
%#         \item Initial GCIS release was one year earlier (May, 2013)
%#     \end{itemize}
%# 
...
\frame{
    ...
    \begin{itemize}
        ...
        \item \href{http://data.globalchange.gov/platform/aqua}{/platform/aqua}
        \item \href{http://data.globalchange.gov/instrument/modis}{/instrument/modis}
        \item \href{http://data.globalchange.gov/model/ccsm3}{/model/ccsm3}
    \end{itemize}
}
...
\frame{
    \frametitle{\insertsubsectionhead}
    Associations between GCIS identifiers and external terms.
    \begin{itemize}
        \item GCIS identifier : /platform/aqua
        \item PODAAC identifier : AQUA
        \item CEOS identifier : 206
    \end{itemize}
}
...
\subsection{Relational Model Changes}
\frame{
    \frametitle{\insertsubsectionhead}
...
\subsection{Semantic Model Changes}
\frame{
    \frametitle{\insertsubsectionhead}
